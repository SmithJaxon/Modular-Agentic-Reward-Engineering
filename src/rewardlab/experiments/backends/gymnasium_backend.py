"""
Summary: Gymnasium backend adapter for deterministic local experiment execution.
Created: 2026-04-02
...
class GymnasiumBackendAdapter(EnvironmentBackendAdapter):
    """
    Execute deterministic Gymnasium-backed performance and reflection probes.
    """
    ...
    def run_performance(self, payload: ExperimentInput) -> ExperimentOutput:
        """
        Execute a deterministic Gymnasium performance probe for the given payload.
        """
