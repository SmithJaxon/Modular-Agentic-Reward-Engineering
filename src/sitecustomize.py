"""Runtime compatibility shims for running RewardLab in Python 3.8 containers.

This module is auto-imported by Python's ``site`` startup hook when present on
``PYTHONPATH``. It backports a few symbols used by the codebase that were
...
# Python >=3.11 provides enum.StrEnum.
...
# Python <3.10 dataclasses.dataclass does not accept the "slots" keyword.
