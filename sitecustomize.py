"""Project-root startup shims for Python runtimes older than 3.11.

This root-level module ensures compatibility shims are auto-imported when the
repository root is the working directory (for example inside Isaac Gym Docker).
"""
